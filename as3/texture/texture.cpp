...
int main(void) {
    ...
    glm::mat4 view = glm::lookAt(glm::vec3(50, 100, 200), glm::vec3(0, 80, 0), glm::vec3(0, 1, 0));
    glm::mat4 projection = glm::perspective(glm::radians(60.0f), 4.0f / 3.0f, 0.1f, 1000.0f);

    // Compile and use shaders
    Shader shader("../texture/vshader.vs", "../texture/fshader.fs");
    shader.use();
...
void dump_framebuffer_to_ppm(std::string prefix, unsigned int width, unsigned int height) {
    ...
    std::string file = "../results/timmy_t.ppm";
