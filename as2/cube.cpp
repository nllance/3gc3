...
int main(void) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Relevant positions
        float xEarthToSun = 20 * cos(glm::radians(get_earth_rotate_angle_around_sun(day)));
        float zEarthToSun = -20 * sin(glm::radians(get_earth_rotate_angle_around_sun(day)));
        float xMoonToEarth = 10 * cos(glm::radians(get_moon_rotate_angle_around_earth(day)));
        float zMoonToEarth = -10 * sin(glm::radians(get_moon_rotate_angle_around_earth(day)));

        // View matrix
        glm::vec3 camPos = glm::vec3(50.0f, 50.0f, 100.0f);
        glm::vec3 camTarget = glm::vec3(xEarthToSun + xMoonToEarth, 0.0f, zEarthToSun + zMoonToEarth);
        glm::mat4 view;
        ...
        // The sun revolves
        sunModel = glm::rotate(sunModel, glm::radians(get_sun_rotate_angle_around_itself(day)), glm::vec3(0.0f, 1.0f, 0.0f));
        ...
        earthModel = glm::rotate(earthModel, glm::radians(get_earth_rotate_angle_around_itself(day)), glm::vec3(0.0f, 1.0f, 0.0f));
        ...
        // The moon revolves
        moonModel = glm::rotate(moonModel, glm::radians(get_moon_rotate_angle_around_itself(day)), glm::vec3(0.0f, 1.0f, 0.0f));
